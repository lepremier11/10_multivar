...
ggsave("../output/clustervalidationk_4.png",
       width = 10,
       height = 20)  
...
ggsave("../output/clustervalidationk_3.png",
       width = 10,
       height = 20)  
...
fviz_cluster(mod_km4,
             data = weather_norm, title = "cluster plot for k = 4"
             )
# For k = 3
fviz_cluster(mod_km,
             data = weather_norm
